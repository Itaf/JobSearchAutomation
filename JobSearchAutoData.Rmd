...
```{r}
#take 80% of the data for training, and leave 20% for testing...
...
post(tree.balanced.fit,file="C:/Users/ITAFO/Documents/DATA 5000/Project/Data/decisionTree(balanced).ps") #create postscript plot of decision tree
...
tree.balanced.prob.cm <- table(Actual=tree.balanced.prob.pred.t$real.balanced, Predicted=tree.balanced.prob.pred.t$predicted.balanced)
...
```{r}
ensemble.rose.pred <- ensemble(test.balanced.pred, tree.balanced.class.pred, tree.balanced.prob.pred.t$predicted.balanced, nb.balanced.pred, nnet.balanced.pred)
...
train1.ensemble.pred <- ensemble(train1.pred1, train1.pred2, train1.pred3, train1.pred4, train1.pred5)
...
train2.ensemble.pred <- ensemble(train2.pred1, train2.pred2, train2.pred3, train2.pred4, train2.pred5)
...
train3.ensemble.pred <- ensemble(train3.pred1, train3.pred2, train3.pred3, train3.pred4, train3.pred5)
...
train4.ensemble.pred <- ensemble(train4.pred1, train4.pred2, train4.pred3, train4.pred4, train4.pred5)
...
train5.ensemble.pred <- ensemble(train5.pred1, train5.pred2, train5.pred3, train5.pred4, train5.pred5)
