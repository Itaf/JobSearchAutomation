...
train1.ensemble.cm <- table(Actual=job_candidate$Response[test], Predicted=train1.ensemble.pred)
train1.ensemble.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train1.ensemble.cm)) / sum(train1.ensemble.cm) 
train1.ensemble.cm["Yes", "Yes"] / sum(train1.ensemble.cm["Yes", ])
train1.ensemble.cm["No", "No"] / sum(train1.ensemble.cm["No", ])
train1.ensemble.cm["Yes", "Yes"] / sum(train1.ensemble.cm[, "Yes"])
...
train2.ensemble.cm <- table(Actual=job_candidate$Response[test], Predicted=train2.ensemble.pred)
train2.ensemble.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train2.ensemble.cm)) / sum(train2.ensemble.cm) 
train2.ensemble.cm["Yes", "Yes"] / sum(train2.ensemble.cm["Yes", ])
train2.ensemble.cm["No", "No"] / sum(train2.ensemble.cm["No", ])
train2.ensemble.cm["Yes", "Yes"] / sum(train2.ensemble.cm[, "Yes"])
...
train3.ensemble.cm <- table(Actual=job_candidate$Response[test], Predicted=train3.ensemble.pred)
train3.ensemble.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train3.ensemble.cm)) / sum(train3.ensemble.cm) 
train3.ensemble.cm["Yes", "Yes"] / sum(train3.ensemble.cm["Yes", ])
train3.ensemble.cm["No", "No"] / sum(train3.ensemble.cm["No", ])
train3.ensemble.cm["Yes", "Yes"] / sum(train3.ensemble.cm[, "Yes"])
...
train4.ensemble.cm <- table(Actual=job_candidate$Response[test], Predicted=train4.ensemble.pred)
train4.ensemble.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train4.ensemble.cm)) / sum(train4.ensemble.cm) 
train4.ensemble.cm["Yes", "Yes"] / sum(train4.ensemble.cm["Yes", ])
train4.ensemble.cm["No", "No"] / sum(train4.ensemble.cm["No", ])
train4.ensemble.cm["Yes", "Yes"] / sum(train4.ensemble.cm[, "Yes"])
...
train5.ensemble.cm <- table(Actual=job_candidate$Response[test], Predicted=train5.ensemble.pred)
train5.ensemble.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train5.ensemble.cm)) / sum(train5.ensemble.cm) 
train5.ensemble.cm["Yes", "Yes"] / sum(train5.ensemble.cm["Yes", ])
train5.ensemble.cm["No", "No"] / sum(train5.ensemble.cm["No", ])
train5.ensemble.cm["Yes", "Yes"] / sum(train5.ensemble.cm[, "Yes"])
...
train1.ensemble2.cm <- table(Actual=job_candidate$Response[test], Predicted=train1.ensemble2.pred)
train1.ensemble2.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train1.ensemble2.cm)) / sum(train1.ensemble2.cm) 
train1.ensemble2.cm["Yes", "Yes"] / sum(train1.ensemble2.cm["Yes", ])
train1.ensemble2.cm["No", "No"] / sum(train1.ensemble2.cm["No", ])
train1.ensemble2.cm["Yes", "Yes"] / sum(train1.ensemble2.cm[, "Yes"])
...
train2.ensemble2.cm <- table(Actual=job_candidate$Response[test], Predicted=train2.ensemble2.pred)
train2.ensemble2.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train2.ensemble2.cm)) / sum(train2.ensemble2.cm) 
train2.ensemble2.cm["Yes", "Yes"] / sum(train2.ensemble2.cm["Yes", ])
train2.ensemble2.cm["No", "No"] / sum(train2.ensemble2.cm["No", ])
train2.ensemble2.cm["Yes", "Yes"] / sum(train2.ensemble2.cm[, "Yes"])
...
train3.ensemble2.cm <- table(Actual=job_candidate$Response[test], Predicted=train3.ensemble2.pred)
train3.ensemble2.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train3.ensemble2.cm)) / sum(train3.ensemble2.cm) 
train3.ensemble2.cm["Yes", "Yes"] / sum(train3.ensemble2.cm["Yes", ])
train3.ensemble2.cm["No", "No"] / sum(train3.ensemble2.cm["No", ])
train3.ensemble2.cm["Yes", "Yes"] / sum(train3.ensemble2.cm[, "Yes"])
...
train4.ensemble2.cm <- table(Actual=job_candidate$Response[test], Predicted=train4.ensemble2.pred)
train4.ensemble2.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train4.ensemble2.cm)) / sum(train4.ensemble2.cm) 
train4.ensemble2.cm["Yes", "Yes"] / sum(train4.ensemble2.cm["Yes", ])
train4.ensemble2.cm["No", "No"] / sum(train4.ensemble2.cm["No", ])
train4.ensemble2.cm["Yes", "Yes"] / sum(train4.ensemble2.cm[, "Yes"])

#results of 5th ensemble of classifiers
train5.ensemble2.pred <- ensemble(train5.other.fit1, train5.other.fit2, train5.other.fit3, train5.other.fit4, train5.other.fit5)

train5.ensemble2.cm <- table(Actual=job_candidate$Response[test], Predicted=train5.ensemble2.pred)
train5.ensemble2.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(train5.ensemble2.cm)) / sum(train5.ensemble2.cm) 
train5.ensemble2.cm["Yes", "Yes"] / sum(train5.ensemble2.cm["Yes", ])
train5.ensemble2.cm["No", "No"] / sum(train5.ensemble2.cm["No", ])
train5.ensemble2.cm["Yes", "Yes"] / sum(train5.ensemble2.cm[, "Yes"])

#create an ensemble of the above 5 ensembles...
ensemble.of.ensembles2 <- ensemble(train1.ensemble2.pred, train2.ensemble2.pred, train3.ensemble2.pred, train4.ensemble2.pred, train5.ensemble2.pred)

ensemble.of.ensembles2.cm <- table(Actual=job_candidate$Response[test], Predicted=ensemble.of.ensembles2)
ensemble.of.ensembles2.cm

#calculate prediction accuracy, sensitivity (recall), specificity, and precision...
sum(diag(ensemble.of.ensembles2.cm)) / sum(ensemble.of.ensembles2.cm) 
ensemble.of.ensembles2.cm["Yes", "Yes"] / sum(ensemble.of.ensembles2.cm["Yes", ])
ensemble.of.ensembles2.cm["No", "No"] / sum(ensemble.of.ensembles2.cm["No", ])
ensemble.of.ensembles2.cm["Yes", "Yes"] / sum(ensemble.of.ensembles2.cm[, "Yes"])
```
