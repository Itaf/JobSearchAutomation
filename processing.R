...
for(j in jobSamples)
{
  j$jobpost <- tolower(j$jobpost)
  j$Title <- tolower(j$Title)
  j$Company <- tolower(j$Company)
  j$Term <- tolower(j$Term)
  j$Eligibility <- tolower(j$Eligibility)
  j$Audience <- tolower(j$Audience)
  j$JobDescription <- tolower(j$JobDescription)
  j$JobRequirment <- tolower(j$JobRequirment)
  j$RequiredQual <- tolower(j$RequiredQual)
  j$ApplicationP <- tolower(j$ApplicationP)
  j$Notes <- tolower(j$Notes)
  j$AboutC <- tolower(j$AboutC)
